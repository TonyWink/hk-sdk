...
public interface HCNetSDK extends StdCallLibrary {
    ...
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(SdkPath.ROOT_PATH+"\\dll\\HcNetSdk\\HCNetSDK",
            HCNetSDK.class);
    /***宏定义***/
    //常量
...
public static class NET_DVR_MACFILTER_CFG extends Structure{

    public int          dwSize;
    public byte         byEnabled;
    public byte         byPermissionType;
    public byte []      byRes1 = new byte[2];
    public byte [] []   szMacAddress = new byte[48][6];
    public byte []      byRes = new byte[128];
...
public static class NET_DVR_FTPUPLOADCFG extends Structure{
            public  int                           dwSize;
            public byte                           byEventType;
            public byte                           byMode;
            public byte []                        byRes = new byte[62];
            public NET_DVR_FTPUPLOAD_PARAM []   struCustomVehicle = new NET_DVR_FTPUPLOAD_PARAM[12];
            public byte []                        byRes1 = new byte[1024];
}

public static class NET_DVR_FTPUPLOAD_PARAM extends Structure{
      public byte[]   szRuleTypeItem = new byte[20];
...
public static class NET_DVR_GBT28181_ACCESS_CFG extends Structure{
			    ...
			    public NET_DVR_GBT28181_ACCESS_CFG( ) {
	                super();
				}
	
                public NET_DVR_GBT28181_ACCESS_CFG(int size) {
					super(size);
				}
 ...
 /***API函数声明,详细说明见API手册***/
   ...
   public static interface fLoginResultCallBack extends StdCallCallback {
        public void invoke(NativeLong lUserID, int dwResult,
